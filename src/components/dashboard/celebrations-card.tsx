...
export const CelebrationsCard = () => {
  ...
  return (
    <div className="bg-white shadow-md border p-3  rounded-lg">
      ...
      <div className="flex mb-4 bg-[#f2f2f2] border p-1.5 px-3 text-sm items-center font-medium justify-between rounded-xl ">
        <div
          className={`${
            activeTab === "birthdays"
              ? "bg-white text-black font-semibold"
              : "text-[#878787]"
          } p-1.5 px-3 rounded-lg cursor-pointer transition-all ease-in-out duration-500`}
